...
const experience = [
    {
        ...
        description: 'Explored microarchitectural timing attack vectors on various processor architectures.',
        duration: 'Aug 2024 – Dec 2024'
    },
    {
        title: 'Teaching Assistant, Side Channel Analysis',
        description: 'Supported course delivery and student learning for Side Channel Analysis.',
        duration: 'Aug 2024 – Dec 2024'
    }
];
    ...
    <section id="profile" style={sectionStyle}>
        <div style={{ display: "flex", alignItems: "center", gap: 32, flexWrap: "wrap" }}>
            ...
            <div style={{ flex: 1, minWidth: 220 }}>
                <h1 style={{ fontSize: "2em", marginBottom: 8 }}>Gobinda Pandey</h1>
